...
const LoginForm = () => {
  ...
  return (
    ...
    >
      <Typography  sx={{color:"#1976d2", caretColor:"transparent", cursor:"pointer"}}   mb={3} variant="h4">
        Iniciar Sesión
      </Typography>
      ...
      <form onSubmit={formik.handleSubmit} style={{ width: "100%" }}>
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
          ...
          <Typography variant="body2" sx={{ marginBottom: "1em",caretColor:"transparent",
          cursor:"pointer", }}>
          ...
          <Typography variant="body2" sx={{ marginBottom: "0.5em", caretColor:"transparent", cursor:"pointer" }}>
            ¿Olvidaste tu contraseña?
          </Typography>
          <Typography variant="body2" sx={{caretColor:"transparent",
          cursor:"pointer"}}>
