...
export default function TaskInfoAndEdit() {
  ...
  const handleStatusChange = async (newStatus) => {
    try {
      ...
      console.log("esto es lo que me da el status en taskinfoAndEdit",newStatus)
        ...
        >
          {({ values, handleChange, setFieldValue, isSubmitting }) => (
            <Form>
              ...
              <Button
                sx={{ backgroundColor: "#84C7AE", color: "#fff", marginBottom: "2em", marginTop: "2em", marginRight: "1em" }}
                type="submit"
              ...
              <Button
                sx={{ backgroundColor: "#84C7AE", color: "#fff", marginBottom: "2em", marginTop: "2em", marginLeft: "1em" }}
                onClick={CreatePDFButton}
              >
                Crear PDF
              </Button>
            </Form>
