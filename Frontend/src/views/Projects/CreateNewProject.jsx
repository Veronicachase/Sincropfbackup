...
import { Container, Box, Grid, TextField, Button, MenuItem, Typography, CircularProgress } from "@mui/material";
import {
  ProjectTextField,
  ProjectTextField2,
              ...
              <Grid container spacing={3} alignItems="center">
                <Grid container spacing={2}>
                  {ProjectTextField.map((field) => (
                    <Grid key={field.name} item xs={12} sm={field.name === "addressDescription" ? 12 : 6}>
                      <TextField
                        name={field.name}
                        label={field.label}
                        type={field.type}
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    fullWidth
                    variant="outlined"
                    error={touched.constructionType && Boolean(errors.constructionType)}
