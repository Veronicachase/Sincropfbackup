...
export default function Employee() {
  ...
  return (
    <Box>
      <Toaster />
      <Box sx={{ marginLeft: "3em", marginBottom: "2em", marginTop:"2em" }}>
      ...
      >
        {({ isSubmitting, errors, touched }) => (
          <Form>
            <Box sx={{ width: "90%", margin: "0 auto", backgroundColor: "#fff", padding: "2em", borderRadius: "10px", boxShadow: 3 }}>
      ...
      >
        {({ isSubmitting, errors, touched }) => (
          <Form>
            <Box sx={{ width: "90%", margin: "0 auto", marginTop: "2em", backgroundColor: "#fff", padding: "2em", borderRadius: "10px", boxShadow: 3 }}>
      ...
      <Box sx={{ marginTop: "2em", backgroundColor: "#fff", width: "90%", margin: "2em auto", padding: "2em", borderRadius: "10px", boxShadow: 3 }}>
