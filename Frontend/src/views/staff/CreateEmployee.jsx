    ...
    >
      {({ isSubmitting, setFieldValue }) => (
        <Form>
          ...
          >
            <Typography variant="h5" gutterBottom sx={{ textAlign: 'center', marginBottom: '1em' }}>
              Crear Trabajador
            </Typography>
            <Grid container spacing={3}>
              ...
              <Grid container direction="column" alignItems="center" spacing={2}>
                <Typography sx={{ marginTop: '2em', fontWeight: 'bold', color: '#1976d2' }}>
...
//               <Grid container direction="column" alignItems="center" spacing={2}>
//                 <Typography sx={{ marginTop: "2em", color: '#1976d2', fontWeight: 'bold' }}>Equipo Reglamentario Entregado</Typography>
//                 <Grid container item justifyContent="center" spacing={2}>
//                   <Grid item>
//                     <Button
//                       sx={{
